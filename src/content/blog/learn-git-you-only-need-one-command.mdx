...
## My Commits For Callout Component
If you see the 'Callout' component in this article. You can see it as the 'Prompt' box and the 'Takeaway' box.

I created them at different times, so they were separate components, so here are my commits to bring them into one single component and into this article.
