...
Git might sound complicated, but the thing is, to 'glide code' you only really need to know how to do two things: commit and reset your code.
...
## 2. Resetting Code
Resetting your code instantly drops all the code that you've written or generated but haven't yet committed. This command is going to be your best friend.
...
As you use git in your development workflow, the use cases will become very clear very quickly. Another benefit is that this process also helps you think through developing a feature in chunks of work. You should think through these chunks and make commits for each.
