---
title: "Learn Git: You Only Need One Command"
...
If you aren't using git, stop developing and invest an hour today. I guarantee you'll see a full ROI within a week.

If you've heard of git, it might sound complicated, but the thing is, to 'glide code' you only really need to know how to do one thing: commit code.

If you can commit code, you will instantly reduce a whole lot of friction when you're developing a new product.

You can commit code with 2 really simple commands in the terminal:
...
This instantly drops all the code that you've generated but haven't yet committed.

Honestly, this command is going to be your best friend. So I'm going to repeat it.

<CodeDisplay language="bash">
{`git reset --hard`}
</CodeDisplay>

You might not believe me just yet, but you will soon. Here's why:
...
As you use it, the use cases will become very clear very quickly. It also helps you think through developing a feature in chunks of work. You should think through these chunks and make commits for each.
...
2. Update the item to show if it is 'High Priority'
3. Move 'High Priority' items to the top of the list
...
Now it kind of leaves you with something that is a weird mix of the jumpy transition it generated and the newly requested sliding transition. This is common with code-generation - when it has added the code, it picks up on the extra code and it's still being considered in the newly created code.

So, come here git! Type:

<CodeDisplay language="bash">
{`git reset --hard`}
</CodeDisplay>

This will reset your code back to your last commit. So, we've gotten rid of the code that has spiralled and gone a bit wonky and we're back to our nice clean code that we're happy with.
...
Perfect. This has a much better chance of coming out as you like. You experimented a little bit and it helped you get a clear vision of what you want so it was super simple to revert back to your clean code and you were able to much more easily get what you want.
...
Now you can merge it to your 'main' branch knowing that you have a feature working exactly as you want.

This might slow you down a little bit to start but overall you will save A LOT of time.
...
When you've got that down, you can take a look at branches, which really aren't that much more complicated!
